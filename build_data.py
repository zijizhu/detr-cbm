...
def process_batch_outputs(matcher, postprocess, outputs, orig_size, scale, area_thresh, square):
    if orig_size:
...
if __name__ == '__main__':
    ...
    for i in tqdm(range(1, 60)):
        ...
        for batch in detr_outputs:
            processed += process_batch_outputs(matcher, postprocess, batch, args.orig_size, args.scale, args.area_thresh, args.square)
